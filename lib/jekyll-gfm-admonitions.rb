...
#       title = (::Regexp.last_match(2).strip.empty? || ::Regexp.last_match(2).strip == '<br />' || ::Regexp.last_match(2).strip == '</p>') ? type.capitalize     : ::Regexp.last_match(2).strip
        title = (::Regexp.last_match(2).strip.empty? || ::Regexp.last_match(2).strip == '<br />' || ::Regexp.last_match(2).strip == '</p>') ? ADMONITION_ja[type] : ::Regexp.last_match(2).strip
